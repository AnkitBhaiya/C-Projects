...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' for Tata Safari."<<endl;
        cout<<"\t\t\t\tEnter 'B' for Mahindra Scorpio."<<endl;
        cout<<"\t\t\t\tEnter 'C' for Hyundai Creta."<<endl;
        cout<<endl;
 ...
 if(carmodel=="A")
 {
 	system("CLS");
		...
		cout<<"You have choosed Tata Safari model 2020"<<endl;
...
sleep(2);
  ...
  if(carmodel=="B")
  {
  	system("CLS");
		...
		cout<<"You have choosed Mahindra Scorpio model 2019"<<endl;
 ...
 {
 	system("CLS");
	     cout<<"You have choosed Hyundai Creta model 2021"<<endl;
