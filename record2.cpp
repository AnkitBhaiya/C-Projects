...
void student::getdata()
{
    ...
    cin.ignore();
    cin.getline(name,50);
    cout<<"Enter Student Physics Grade : "<<endl;
    cin>>physics;
    cout<<"Enter Student's Chemistry Grade : "<<endl;
    cin>>chemistry;
    cout<<"Enter Student's Mathematics Grade : "<<endl;
    cin>>mathematics;
    cout<<"Enter Student's English Grade : "<<endl;
    cin>>english;
    cout<<"Enter the Computer Science Grade : "<<endl;
    cin>>comscience;
    calculate();
}
